...
staticBuiltInFunctions = {	
	...
	"all" : { (collections.abc.Iterable,) : bool }, 
	"any" : { (collections.abc.Iterable,) : bool }, 
	"bin" : { (int,) : str }, 
	...
	"filter" : { (type(lambda x : x), collections.abc.Iterable) : list },
	"getattr" : None, 
	"globals" : dict, 
	"hasattr" : bool, #TODO
	"hash" : int, 
	...
	"iter" : { (collections.abc.Iterable,) : None, (None, object) : None },
	"len" : { (str,) : int, (tuple,) : int, (list,) : int, (dict,) : int },
	"locals" : dict, 
	"map" : { (None, collections.abc.Iterable) : list }, #TODO
	"max" : { (collections.abc.Iterable,) : None },
	"min" : { (collections.abc.Iterable,) : None },
	"oct" : { (int,) : str },
	"ord" : { (str,) : int },
	...
	"sorted" : { (collections.abc.Iterable,) : list },
	"sum" : { (collections.abc.Iterable,) : None },
	"vars" : dict, #TODO
	"zip" : { () : list, (collections.abc.Iterable,) : list}
	}
...
builtInStringFunctions = {
	...
	"istitle" : { () : bool },
	"isupper" : { () : bool }, 
	"join" : { (collections.abc.Iterable,) : str, (collections.abc.Iterable,str) : str },
	"ljust" : { (int,) : str },
	"lower" : { () : str }, 
	"lstrip" : { () : str, (str,) : str },
	"partition" : { (str,) : tuple }, 
...
randomFunctions = { 
	"seed" : { () : None, (collections.abc.Hashable,) : None }, 
	"getstate" : { () : object },
	...
	"randint" : { (int, int) : int }, 
	"choice" : { (collections.abc.Iterable,) : object },
	"shuffle" : { (collections.abc.Iterable,) : None, 
				  (collections.abc.Iterable, type(lambda x : x)) : None },
	"sample" : { (collections.abc.Iterable, int) : list }, 
	"random" : { () : float },
