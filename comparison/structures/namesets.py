...
builtInListFunctions = dict(
    list(mutatingListFunctions.items()) + list(staticListFunctions.items())
)
...
copyFunctions = {"copy": None, "deepcopy": None}

timeFunctions = {"clock": {(): float}, "time": {(): float}}

errorFunctions = {"AssertionError": {(str,): object}}

allStaticFunctions = dict(
    list(staticBuiltInFunctions.items())
    + list(staticTypeCastBuiltInFunctions.items())
    + list(builtInStringFunctions.items())
    + list(staticListFunctions.items())
    + list(staticDictFunctions.items())
    + list(mathFunctions.items())
)

allMutatingFunctions = dict(
    list(mutatingBuiltInFunctions.items())
    + list(mutatingTypeCastBuiltInFunctions.items())
    + list(mutatingListFunctions.items())
    + list(randomFunctions.items())
...
astNames = {
    ast.Module: "Module",
    ast.Interactive: "Interactive Module",
    ast.Expression: "Expression Module",
    ast.Suite: "Suite",
    ...
    ast.Invert: "Invert",
    ast.Not: "Not",
    ast.UAdd: "Unsigned Add",
    ast.USub: "Unsigned Subtract",
    ast.Eq: "==",
    ast.NotEq: "!=",
    ast.Lt: "<",
    ast.LtE: "<=",
    ...
    ast.ExceptHandler: "Except Handler",
